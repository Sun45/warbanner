...
public class TeamDetailFragment extends BaseFragment {
    ...
    protected void initView() {
        ...
        mBoss = mRoot.findViewById(R.id.boss);
    ...
    protected void dataRequest() {
        ...
        mBoss.setText(teamModel.getNumber());
        showDamage();
            ...
            public void onClick(View v) {
                ...
                DialogInputExtKt.input(dialog, Utils.getStringWithPlaceHolder(R.string.team_detail_damage_dialog_hint, teamModel.getEllipsisdamage() + "w"), null, damage + "", null, InputType.TYPE_CLASS_NUMBER, null, true, false, new Function2<MaterialDialog, CharSequence, Unit>() {
                    ...
                    public Unit invoke(MaterialDialog materialDialog, CharSequence charSequence) {
                        ...
                        if (teamCustomizeModel == null) {
                            teamCustomizeModel = ClanwarHelper.buildCustomizeModelAndSave(teamModel, damage);
                        } else {
                            ClanwarHelper.editCustomizeModelAndSave(teamCustomizeModel, damage);
                        }
                        showDamage();
                        return null;
                    }
        ...
        mDamageClean.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ClanwarHelper.deleteCustomizeModel(teamCustomizeModel);
                teamCustomizeModel = null;
                showDamage();
            }
        });
        if (teamModel.isAuto()) {
